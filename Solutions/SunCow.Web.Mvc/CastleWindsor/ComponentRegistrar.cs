namespace SunCow.Web.Mvc.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddTasksTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("SunCow.Tasks")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("SunCow.Domain"));
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container) 
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("SunCow.Infrastructure")
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("SunCow.Web.Mvc")
                    .BasedOn<NHibernateQuery>()
                    .WithService.DefaultInterfaces());

            container.Register(
                AllTypes.FromAssemblyNamed("SunCow.Infrastructure")
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("SunCow.Tasks")
